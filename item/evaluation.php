...
$sql_code = "SELECT * FROM evaluation WHERE itemID=$itemID AND personID=$personID";
...
if ($rows == 1) {
    ...
    $sql_code = "INSERT INTO `evaluation` (`personID`, `itemID`, `value`) VALUES ($itemID, $personID, $evaluation);";
    $sql_query = $mysqli->query($sql_code) or die("Falha na execução do código SQL: " . $mysqli);
}
