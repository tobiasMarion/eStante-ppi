                ...
                <tbody>
                    <tr class="text-center py-2 border-b h-16">
                        ...
                        <td class="hidden md:table-cell">
                            ...
                            <button><img src="./static/assets/icons/filled-star.svg" alt="Estrla"></button>
                            <button><img src="./static/assets/icons/filled-star.svg" alt="Estrla"></button>
                            <button><img src="./static/assets/icons/unfilled-star.svg" alt="Estrla"></button>
                        </td>
                        <td class="text-slate-500 text-xs md:text-sm hidden md:table-cell">8º</td>
                        <td class="text-slate-500 text-xs md:text-sm hidden md:table-cell">Física</td>
                        <td class="text-slate-500 text-xs md:text-sm hidden md:table-cell">4</td>
